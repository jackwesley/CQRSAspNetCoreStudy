...
namespace Eventos.IO.Domain.Eventos.Commands
{
...

    {
        ...
        public void Handle(AtualizarEventoCommand message)
        {
            ...
            {
                _bus.RaiseEvent(new DomainNotification(message.MessageType, "Não é possível atualizar que não seja online um evento sem informar o endereço"));
                return;
            }
            ...
            if (Commit())
            {
                _bus.RaiseEvent(new EventoAtualizadoEvent(evento.Id, evento.Nome, evento.DescricaoCurta, evento.DescricaoLonga, evento.DataInicio,
